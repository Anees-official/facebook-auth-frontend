...
<div className="main w-full flex flex-col md:flex-row">
  ...
  <div className="right md:w-2/4 md:justify-center mt-10 md:mt-24 xl:h-3/4">
    ...
    <div className="input-box bg-white">
      ...
      <div className='flex'>
      <input className='input-1 m-2 border-2 w-2/4 text-start'
          placeholder='Enter Name'/>
          <input className='input-1 w-2/4 text-start'
        ...
        <input className='input-1 text-start'
          ...
          <hr className='m-4'/>
          <div className='text-center'>
            <button className=' text-white text-center bg-green-500 text-2xl p-2 mx-16 rounded-lg'><Link href="/login">Login</Link></button>
          </div>
          
      </form>
    </div>
    <p className='text-lg p-4'><a href="/about" className='font-semibold'>Create a Page</a> for a celebrity, brand or business.</p>
